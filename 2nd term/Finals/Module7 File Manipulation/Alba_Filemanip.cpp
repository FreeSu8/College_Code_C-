...
int main (){
    ...
    while (start){
        ...
        cout << "6. Save Record to file" << endl;
        cout << "7. Open the file." << endl;
        cout << "8. Close the File" << endl;
        cout << "9. Exit" << endl;
        cin >> choice;
        switch (choice){
            case 1:
...
void saveRecord() {
    ofstream outFile("player_records.txt", fstream::app);
    Node* current = head;
    while (current != NULL) {
...
void openFile() {
	string line;
	ifstream myfile ("player_records.txt");
	if (myfile.is_open()) {
